...
if (isset($_GET["edit"])) {
    ...
    if (mysqli_num_rows($edit_query_run) > 0) {
        ...
        $e_user_name = $edit_row["username"];

        if ($session_username == $e_user_name) {
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <h1>
                    ...
                    <small class="text-black-50">Edit Profile Details</small>
                </h1>
                <hr/>
                <ol class="breadcrumb">
                    <li><a href="index.php"><i class="fa fa-tachometer-alt"></i>Dashboard /</a></li>
                    <li class="active pl-2"><i class="fas fa-user-edit"></i>Edit Profile</li>
                </ol>
                ...
                if (isset($_POST["submit"])) {
                    ...
                    if (empty($first_name) || empty($last_name) || empty($image) || empty($details)) {
                        ...
                        if (mysqli_query($connectionDB, $update_query)) {
                            ...
                            header("refresh:1 url=editProfile.php?edit=$edit_id");
